...
public class SecurityAuthorities extends TableImpl<SecurityAuthoritiesRecord> {
    ...
    /**
     * The column <code>security.security_authorities.ID</code>. Primary key
     */
    public final TableField<SecurityAuthoritiesRecord, ULong> ID = createField(DSL.name("ID"), SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "Primary key");

    /**
     * The column <code>security.security_authorities.NAME</code>. Authority
     * name e.g. ROLE_ADMIN
     */
    public final TableField<SecurityAuthoritiesRecord, String> NAME = createField(DSL.name("NAME"), SQLDataType.VARCHAR(50).nullable(false), this, "Authority name e.g. ROLE_ADMIN");

    /**
     * The column <code>security.security_authorities.CREATED_BY</code>. ID of
     * the user who created this row
     */
    public final TableField<SecurityAuthoritiesRecord, ULong> CREATED_BY = createField(DSL.name("CREATED_BY"), SQLDataType.BIGINTUNSIGNED, this, "ID of the user who created this row");

    /**
     * The column <code>security.security_authorities.CREATED_AT</code>. Time
     * when this row is created
     */
    public final TableField<SecurityAuthoritiesRecord, LocalDateTime> CREATED_AT = createField(DSL.name("CREATED_AT"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "Time when this row is created");

    /**
     * The column <code>security.security_authorities.UPDATED_BY</code>. ID of
     * the user who updated this row
     */
    public final TableField<SecurityAuthoritiesRecord, ULong> UPDATED_BY = createField(DSL.name("UPDATED_BY"), SQLDataType.BIGINTUNSIGNED, this, "ID of the user who updated this row");

    /**
     * The column <code>security.security_authorities.UPDATED_AT</code>. Time
     * when this row is updated
     */
    public final TableField<SecurityAuthoritiesRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("UPDATED_AT"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "Time when this row is updated");
    ...
    @Override
    public Identity<SecurityAuthoritiesRecord, ULong> getIdentity() {
        return (Identity<SecurityAuthoritiesRecord, ULong>) super.getIdentity();
    }

    @Override
    public UniqueKey<SecurityAuthoritiesRecord> getPrimaryKey() {
        return Keys.KEY_SECURITY_AUTHORITIES_PRIMARY;
    }

    @Override
    public List<UniqueKey<SecurityAuthoritiesRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_SECURITY_AUTHORITIES_UK_SECURITY_AUTHORITIES_NAME);
    }
    ...
    public SecurityUserAuthoritiesPath securityUserAuthorities() {
        if (_securityUserAuthorities == null)
            _securityUserAuthorities = new SecurityUserAuthoritiesPath(this, null, Keys.FK2_USER_AUTHORITIES_AUTHORITY_ID_AUTHORITIES_ID.getInverseKey());
    ...
    public SecurityUsersPath securityUsers() {
        return securityUserAuthorities().securityUsers();
    }
